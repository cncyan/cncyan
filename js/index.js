function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const getNumberInRange = (upper, lower = 0, negate = false) => {
...
class Star {
  ...
  constructor(options) {_defineProperty(this, "DEFAULTS", { fillColor: '#663399' });_defineProperty(this, "STATE", { active: false, life: 0, velocityX: getNumberInRange(3, 1, true), velocityY: getNumberInRange(3, 1, true) });_defineProperty(this, "initCanvas",
...
class ShootingStars {
  ...
  constructor(config) {_defineProperty(this, "DEFAULTS", { particleLife: 300, particleRenderProbability: 0.5, amount: 5, trippy: false });_defineProperty(this, "PARTICLES", []);_defineProperty(this, "reset",
